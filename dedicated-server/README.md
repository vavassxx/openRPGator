...
Build/run on a desktop Linux machine:
    ...
    java -jar dedicated-server/build/libs/dedicated-server-0.1.0.jar --map examples/village.rmap --port 27800

Termux/Android ARM64:

    pkg install openjdk-21
    java -jar dedicated-server-0.1.0.jar --map examples/village.rmap --port 27800
