...
Dedicated server:
    ...
    java -jar dedicated-server/build/libs/dedicated-server-0.4.0.jar --map examples/village.rmap --port 27800

Termux:

    pkg install openjdk-21
    java -jar dedicated-server-0.4.0.jar --map village.rmap --port 27800
